...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Please provide your prefix for all Sentinel tables,
    | or leave it empty if You don't want any prefix. 
    |
    */
    ...
    */
    ...
    'throttling' => [
        ...
        'model' => 'App\Models\Sentinel\Throttle',
